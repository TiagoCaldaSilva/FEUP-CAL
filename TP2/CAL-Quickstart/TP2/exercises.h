...
public:
     ...
     * @param solutions Number of solutions
     */
    void generate(int solutions);
    /**
    ...
    void print() const;
private:
    bool solve3(int &counter, int solutions);
    bool solve2(int &counter);
    std::vector<int> possibleNumbersInTheRow(int row);
    std::vector<int> possibleNumbersInTheColumn(int col);
    std::vector<int> possibleNumbersInTheBlock(int row, int col);
    /**
